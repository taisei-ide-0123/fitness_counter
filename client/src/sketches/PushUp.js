...
class PushUp extends Component {
  ...
  componentDidMount() {
    axios
      ...
      .then((response) => {
        this.setState({
          total_push_up_count: response.data.total_push_up_count,
        })
  ...
  render() {
    const push_up = (p) => {
      ...
      p.save = (e) => {
        ...
        const push_up_count = {
          total_push_up_count: this.state.total_push_up_count + count,
        }
        ...
        axios
          .put(
            '/api/users/total/push-up/count/' + this.state.user,
            push_up_count,
          )
          .then((res) => console.log(res.data))
